...
*/
	public static void main(String[] args) {
		...
		// 메인프레임의 레이아웃은 그리드로 설정하고
		f.setLayout(new GridLayout(2,2));
		
		JPanel panel = new JPanel(); 
		JPanel panel2 = new JPanel();
		
		// 메인프레임에 3번째로 추가할 패널의 레이아웃을 보더로 설정
		panel.setLayout(new BorderLayout());// JPanel도 컨테이너!
		...
		panel.add(new JButton("sub-button3"),"North");
		panel.add(new JButton("sub-button4"),"South");
